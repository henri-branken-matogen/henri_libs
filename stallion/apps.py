...
def Applications_Contracts_Update(NBR, Account, APP_Account_Number1, APP_Account_Number2, APP_Account_Number3,
    ...
    if NBR == 1:
        ...
        if APP_Activation_Days1 is None:
            ...
            pass
        if APP_Activation_Date1 is None:
            APP_Activation_Month1 = None
        else:
        ...
        if APP_Activation_Days2 is None:
            ...
            pass
        if APP_Activation_Date2 is None:
            APP_Activation_Month2 = None
        else:
        ...
        if APP_Activation_Days3 is None:
            ...
            pass
        if APP_Activation_Date3 is None:
            APP_Activation_Month3 = None
        else:
        ...
        if APP_Activation_Days4 is None:
            ...
            pass
        if APP_Activation_Date4 is None:
            APP_Activation_Month4 = None
        else:
        ...
        if APP_Activation_Days5 is None:
            ...
            pass
        if APP_Activation_Date5 is None:
            APP_Activation_Month5 = None
        else:
